...
<body
    ...
    <div class="glass rounded-3xl max-w-3xl w-full p-10 text-white shadow-xl">
        <h1 class="text-4xl font-extrabold text-center mb-10 text-white drop-shadow-lg">
            <i class="fas fa-user-edit text-yellow-400 mr-2"></i> Edit Profile
        </h1>
        ...
        <form action="{{ route('profil.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="flex flex-col items-center space-y-2">
                <div class="relative group w-32 h-32">
                    ...
                    <label for="image"
                        ...
                        <i class="fas fa-camera text-white"></i>&nbsp;Change
                    </label>
                </div>
            ...
            <div>
                <label for="nama_lengkap" class="block mb-1 font-semibold">
                    <i class="fas fa-id-card text-pink-400 mr-2"></i>Full Name
                </label>
            ...
            <div>
                <label for="phone" class="block mb-1 font-semibold">
                    <i class="fas fa-phone text-green-400 mr-2"></i>Phone
                </label>
            ...
            <div>
                <label for="address" class="block mb-1 font-semibold">
                    <i class="fas fa-map-marker-alt text-red-400 mr-2"></i>Address
                </label>
