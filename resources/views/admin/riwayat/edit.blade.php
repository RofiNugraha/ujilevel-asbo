...
<div class="card">
    <div class="card-body" style="width: 850px;">
        <form action="{{ route('admin.riwayat.update', $riwayat->id) }}" method="POST">
            ...
            <input type="text" name="layanan_id" id="layanan_id" value="{{ $riwayat->layanan_id }}" readonly>
            ...
            <input type="text" name="jumlah_bayar" id="jumlah_bayar" value="{{ $riwayat->jumlah_bayar }}" readonly>

            <label for="metode_pembayaran">Metode Pembayaran</label>
            <input type="text" name="metode_pembayaran" id="metode_pembayaran" value="{{ $riwayat->metode_pembayaran }}"
                required>

            <button type="submit">Update</button>
            <a href="{{ route('admin.riwayat.index') }}"><button type="" class=" btn btn-warning">Back</button></a>
        </form>
    </div>
</div>