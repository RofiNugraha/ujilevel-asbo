                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Data Website</h3>
                                ...
                                <form action="{{ route('admin.custom.update', $custom) }}" method="POST"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <div class="current-logo">
                                                            ...
                                                            <img src="{{ asset($custom->logo) }}" alt="Current Logo"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="judul" name="judul"
                                                        value="{{ old('judul', $custom->judul) }}" required>
                                                    @error('judul')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('subjudul', $custom->subjudul) }}">
                                                    @error('subjudul')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control @error('alamat') is-invalid @enderror"
                                                        ...
                                                        rows="3">{{ old('alamat', $custom->alamat) }}</textarea>
                                                    @error('alamat')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('jam_operasional', $custom->jam_operasional) }}"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="url"
                                                        ...
                                                        value="{{ old('link_instagram', $custom->link_instagram) }}"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="url"
                                                        ...
                                                        value="{{ old('link_facebook', $custom->link_facebook) }}"
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="url"
                                                        ...
                                                        value="{{ old('link_whatsapp', $custom->link_whatsapp) }}"
